...
Indem du contributest, stimmst du zu dass dein Code unter der [AGPL v3 License](LICENSE) veröffentlicht wird.
...
By contributing, you agree that your code will be published under the [AGPL v3 License](LICENSE).
